...
#define STRING_CONFIG_H_AUTHOR "Richard Layton and the Luxuri Team" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_TENLOG_MB1_V23
#endif
...
#define CUSTOM_MACHINE_NAME STRINGIFY(TENLOG_CONFIG)
 ...
 */
#define X_DRIVER_TYPE  LUX_XYZ_DRIVER_TYPE
#define Y_DRIVER_TYPE  LUX_XYZ_DRIVER_TYPE
#define Z_DRIVER_TYPE  LUX_XYZ_DRIVER_TYPE
#define X2_DRIVER_TYPE LUX_XYZ_DRIVER_TYPE
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE LUX_XYZ_DRIVER_TYPE
...
#define E0_DRIVER_TYPE LUX_E_DRIVER_TYPE
#define E1_DRIVER_TYPE LUX_E_DRIVER_TYPE
...
#define TEMP_SENSOR_BED LUX_TEMP_SENSOR_BED
...
#define HEATER_0_MAXTEMP LUX_HEATER_0_MAXTEMP
#define HEATER_1_MAXTEMP LUX_HEATER_1_MAXTEMP
...
#define BED_MAXTEMP      LUX_BED_MAXTEMP
...
// #define USE_ZMAX_PLUG LUX_USE_ZMAX_PLUG
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW // Set to LOW to invert the logic of the endstop.
#define Y_MIN_ENDSTOP_HIT_STATE LUX_Y_MIN_ENDSTOP_HIT_STATE // Set to LOW to invert the logic of the endstop.
#define Z_MIN_ENDSTOP_HIT_STATE LUX_Z_MIN_ENDSTOP_HIT_STATE // Set to LOW to invert the logic of the endstop.
#define I_MIN_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define J_MIN_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define K_MIN_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define U_MIN_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define V_MIN_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define W_MIN_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define X_MAX_ENDSTOP_HIT_STATE LOW // Set to LOW to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_HIT_STATE LOW // Set to LOW to invert the logic of the endstop.
#define I_MAX_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define J_MAX_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define K_MAX_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define U_MAX_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define V_MAX_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
#define W_MAX_ENDSTOP_HIT_STATE HIGH // Set to LOW to invert the logic of the endstop.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   LUX_DEFAULT_AXIS_STEPS_PER_UNIT
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 100, 10, 25, 25 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 100, 1000, 1000 }
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN LUX_Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET LUX_NOZZLE_TO_PROBE_OFFSET
...
#define Z_CLEARANCE_BETWEEN_PROBES  6 // Z Clearance between probe points  //RadioActiv
#define Z_CLEARANCE_MULTI_PROBE     6 // Z Clearance between multiple probes  /RadioActiv
...
#define Z_MIN_PROBE_REPEATABILITY_TEST LUX_Z_MIN_PROBE_REPEATABILITY_TEST
...
#define INVERT_E0_DIR LUX_INVERT_E0_DIR
#define INVERT_E1_DIR LUX_INVERT_E1_DIR
...
#define X_BED_SIZE LUX_X_BED_SIZE
#define Y_BED_SIZE LUX_Y_BED_SIZE

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS LUX_X_MIN_POS
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS LUX_X_MAX_POS
#define Y_MAX_POS LUX_Y_MAX_POS
#define Z_MAX_POS LUX_Z_MAX_POS
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  #define MIN_SOFTWARE_ENDSTOP_Z LUX_MIN_SOFTWARE_ENDSTOP_Z
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define NUM_RUNOUT_SENSORS LUX_NUM_RUNOUT_SENSORS // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
...
#define AUTO_BED_LEVELING_UBL LUX_AUTO_BED_LEVELING_UBL
#define MESH_BED_LEVELING LUX_MESH_BED_LEVELING
 ...
 */
#define Z_SAFE_HOMING LUX_Z_SAFE_HOMING
