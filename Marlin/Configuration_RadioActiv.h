...
#define NIX_MACHINE_NAME "RadioActiv - v0.05 [M2.1(xxxxxx)]"
...
#define RADIOACTIV_SHAPING_ENABLED
#define RADIOACTIV_SHAPING_FREQ_X 29.85
#define RADIOACTIV_SHAPING_FREQ_Y 34.39
/*
#### END MY OVERRIDES
*/
// Dual Extruder Tweaks
