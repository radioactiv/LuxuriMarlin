 ...
 */
#define INPUT_SHAPING_X  //RadioActiv
#define INPUT_SHAPING_Y  //RadioActiv
...
#define DEFAULT_MINTRAVELFEEDRATE     30     // (mm/s. °/s for rotational-only moves) Minimum travel feedrate. Set with M205 T.
